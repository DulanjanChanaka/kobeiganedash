...
const Navbar = () => {
  ...
  return (
    <div className=' w-full py-5 top-0 left-0 bg-sky-700 text-white mb-5'>
            ...
            <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen  z-[100]' : ''}>
                <div className={
                    nav
                        ? ' fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-blue-500 p-10 ease-in duration-500'
                    ...
                    <div className=''>
                        <div className='flex w-full items-center justify-between'>
                            ...
                            <div onClick={handleNav} className='rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer bg-white text-black'>
                                <AiOutlineClose />
                            </div>
                        </div>
