...
function Woman() {
  ...
  const handleUpdateData = async () => {
    try {
      const docRef = doc(db, 'woman', 'ynSl6ChVJfYGhdqJQwtC'); // Replace with your actual document ID
  ...
  return (
    <div className='w-full px-5 flex flex-col'>
      <h2 className='text-center text-lg font-bold mb-6'>Update Woman Clinic Data</h2>
